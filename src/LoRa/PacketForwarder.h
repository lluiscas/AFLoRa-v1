...
//class LoRaSignalCounter : public cListener {
//    protected:
//        int counter = 0;
//
//    public:
//        //LoRaSignalCounter LoRaSignalCounter();
//        virtual ~LoRaSignalCounter();
...
class INET_API PacketForwarder : public cSimpleModule, public cListener
{
  ...
  public:
      ...
      int counterOfSentMacFramesFromNodes = 0;
//      LoRaSignalCounter *loRaAppLis;
//      LoRaSignalCounter *loRaMacLis;
};
